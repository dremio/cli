...
COMMAND_SCHEMAS: dict[str, dict] = {
    ...
    "skill.list": {
        "group": "skill",
        "command": "list",
        "description": "List saved AI Agent Skills visible to the current user.",
        "mechanism": "REST",
        "endpoints": ["GET /v1/projects/{pid}/agent/skills"],
        "parameters": [
            {"name": "status", "type": "enum", "required": False, "enum": ["DRAFT", "PUBLISHED"]},
            {"name": "limit", "type": "integer", "required": False, "default": 100},
            {"name": "page_token", "type": "string", "required": False, "flag": "--page-token"},
            {"name": "output", "type": "enum", "required": False, "default": "json", "enum": ["json", "csv", "pretty"]},
            {"name": "fields", "type": "string", "required": False},
        ],
    },
    "skill.get": {
        "group": "skill",
        "command": "get",
        "description": "Get one saved AI Agent Skill by ID.",
        "mechanism": "REST",
        "endpoints": ["GET /v1/projects/{pid}/agent/skills/{skillId}"],
        "parameters": [
            {"name": "skill_id", "type": "string", "required": True, "positional": True},
            {"name": "output", "type": "enum", "required": False, "default": "json", "enum": ["json", "csv", "pretty"]},
            {"name": "fields", "type": "string", "required": False},
        ],
    },
    "skill.create": {
        "group": "skill",
        "command": "create",
        "description": "Create a saved AI Agent Skill.",
        "mechanism": "REST",
        "mutating": True,
        "endpoints": ["POST /v1/projects/{pid}/agent/skills"],
        "parameters": [
            {"name": "name", "type": "string", "required": True, "flag": "--name"},
            {"name": "description", "type": "string", "required": True, "flag": "--description"},
            {"name": "prompt_text", "type": "string", "required": False, "flag": "--prompt-text"},
            {"name": "prompt_file", "type": "string", "required": False, "flag": "--prompt-file"},
            {"name": "status", "type": "enum", "required": False, "default": "DRAFT", "enum": ["DRAFT", "PUBLISHED"]},
            {
                "name": "activation_scope",
                "type": "enum",
                "required": False,
                "default": "ALL",
                "enum": ["ALL", "AGENT", "MANUAL"],
            },
            {"name": "when_to_use", "type": "string", "required": False, "flag": "--when-to-use"},
            {"name": "tags", "type": "string", "required": False, "flag": "--tags"},
            {"name": "metadata", "type": "string", "required": False, "flag": "--metadata"},
            {"name": "output", "type": "enum", "required": False, "default": "json", "enum": ["json", "csv", "pretty"]},
        ],
    },
    "skill.update": {
        "group": "skill",
        "command": "update",
        "description": "Update a saved AI Agent Skill by fetching existing values and applying overrides.",
        "mechanism": "REST",
        "mutating": True,
        "endpoints": ["GET /v1/projects/{pid}/agent/skills/{skillId}", "PUT /v1/projects/{pid}/agent/skills/{skillId}"],
        "parameters": [
            {"name": "skill_id", "type": "string", "required": True, "positional": True},
            {"name": "name", "type": "string", "required": False, "flag": "--name"},
            {"name": "description", "type": "string", "required": False, "flag": "--description"},
            {"name": "prompt_text", "type": "string", "required": False, "flag": "--prompt-text"},
            {"name": "prompt_file", "type": "string", "required": False, "flag": "--prompt-file"},
            {"name": "status", "type": "enum", "required": False, "enum": ["DRAFT", "PUBLISHED"]},
            {"name": "activation_scope", "type": "enum", "required": False, "enum": ["ALL", "AGENT", "MANUAL"]},
            {"name": "tag", "type": "string", "required": False, "flag": "--tag"},
            {"name": "when_to_use", "type": "string", "required": False, "flag": "--when-to-use"},
            {"name": "tags", "type": "string", "required": False, "flag": "--tags"},
            {"name": "metadata", "type": "string", "required": False, "flag": "--metadata"},
            {"name": "output", "type": "enum", "required": False, "default": "json", "enum": ["json", "csv", "pretty"]},
    ...
    "skill.delete": {
        "group": "skill",
        "command": "delete",
        "description": "Delete a saved AI Agent Skill. Cannot be undone.",
        "mechanism": "REST",
        "mutating": True,
        "endpoints": ["DELETE /v1/projects/{pid}/agent/skills/{skillId}"],
        "parameters": [
            {"name": "skill_id", "type": "string", "required": True, "positional": True},
            {"name": "dry_run", "type": "boolean", "required": False, "default": False},
            {"name": "output", "type": "enum", "required": False, "default": "json", "enum": ["json", "csv", "pretty"]},
